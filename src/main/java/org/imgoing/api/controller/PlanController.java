...
public class PlanController {
    ...
    public ImgoingResponse<PlanDto> create(User user, @RequestBody @Valid PlanRequest planSaveRequest) {
        ...
        Plan plan = planService.create(user, newPlan, taskMapper.toEntity(planSaveRequest.getTask()));
    ...
    public ImgoingResponse<PlanDto> modify (
        ...
        Plan modifiedplan = planService.modify(oldPlan, newPlan, taskMapper.toEntity(planRequest.getTask()));
